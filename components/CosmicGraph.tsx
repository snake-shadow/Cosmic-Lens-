...
const CustomShape = (props: any) => {
  ...
  if (type.includes('nebula') || type.includes('cloud')) {
     return (
       // Removed scale-110 to fix glitching on hover. Using brightness instead.
...
const CosmicGraph: React.FC<CosmicGraphProps> = ({ data, onNodeClick }) => {
  return (
    <div className="w-full h-full min-h-[400px] relative bg-space-900/30 rounded-2xl border border-white/5 backdrop-blur-sm overflow-hidden flex flex-col">
      ...
      {/* Container for chart uses simplified absolute positioning to guarantee size availability and avoid -1 dimensions */}
